...
const ItemCard = ({ product }) => {
  const { addedByEmail, addedById, addedByName, category, image, name, orderCount, origin, price, quantity, shortDescription, _id } = product;
    ...
    <div className="max-w-sm rounded overflow-hidden shadow-2xl bg-white pt-5 flex flex-col justify-between">
      ...
      <div className="px-6 py-4 flex flex-col justify-between">
        ...
        <div className="flex justify-between">
          <Link to={`/items/item-update/${_id}`} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            Update
          </Link>
